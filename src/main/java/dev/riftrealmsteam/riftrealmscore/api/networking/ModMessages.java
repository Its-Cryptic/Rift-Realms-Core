package dev.riftrealmsteam.riftrealmscore.api.networking;
...
import dev.riftrealmsteam.riftrealmscore.api.networking.packet.ExampleC2SPacket;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(RiftRealmsCore.MODID, "messages"))
